...
Console.WriteLine("\n--- IsInRange ---");
Console.WriteLine("IsInRange(5, 1, 10): " + MathHelper.IsInRange(5, 1, 10));   
Console.WriteLine("IsInRange(1, 1, 10): " + MathHelper.IsInRange(1, 1, 10));   
Console.WriteLine("IsInRange(10, 1, 10): " + MathHelper.IsInRange(10, 1, 10)); 
Console.WriteLine("IsInRange(15, 1, 10): " + MathHelper.IsInRange(15, 1, 10)); 
